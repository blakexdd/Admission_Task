...
// all events we listen to from `Server` modules
...
/**
 * A container of server modules representing a connection to a MongoDB topology.
 *
...
class Topology extends EventEmitter {
   ...
   * Create a topology
   *
   * @param {Array|String} [seedlist] a string list, or array of Server modules to connect to
  ...
  constructor(seedlist, options) {
    ...
    this.s = {
      ...
      // a map of server modules to normalized addresses
      servers: new Map(),
      // Server Session Pool
...
/**
 * Create `Server` modules for all initially known servers, connect them, and assign
...
function updateServers(topology, incomingServerDescription) {
  ...
  // for all servers no longer known, remove their descriptions and destroy their modules
