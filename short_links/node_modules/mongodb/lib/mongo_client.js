 ...
 * @param {boolean} [options.autoReconnect=true] Enable autoReconnect for single server modules
 ...
 * @param {boolean} [options.auto_reconnect=true] Enable auto reconnecting for single server modules
...
/**
 * Create a new Db instance sharing the current socket connections. Be aware that the new db modules are
 * related in a parent-child relationship to the original instance so that events are correctly emitted on child
 * db modules. Child db modules are cached so performing db('db1') twice will return the same instance.
